...
<?php get_header(); ?>
    ...
    <section class="banner" id="top" style="background-image:url(<?php echo get_field( 'fon_image' )['url']; ?>)">
        <div class="container">
            <div class="left">
                ...
                <a href="<?php the_field( 'link_button' ); ?>"
                   class="brown_button"><?php the_field( 'text_button' ); ?></a>
            </div>
            <div class="right">
    ...
    <div class="container">
    <div class="title">
        <h3><?php the_field( 'zagolovok_top_knyg' ); ?></h3>
    </div>
    <div class="slider">
...
foreach ( $posts as $post ) {
    ...
    <div class="slide">
        ...
        <a href="<?php the_permalink();?>"><img src="<?php echo  get_the_post_thumbnail_url(); ?>" alt="" class="scale"></a>

        <div class="slide_text">
            <p><?php the_field('avtor'); ?></p>
        </div>
        <div class="slide_title">
            <p><?php the_title(); ?></p>
        </div>
        <div class="slide_price">
            <h4><?php the_field('czina'); ?></h4>
        </div>
    </div>
    ...
    <div class="btn">
        <a href="<?php the_field( 'posylannya_knopky_top_knyg' ); ?>" class="brown_button" target="_blank"><?php the_field( 'tekst_knopky_top_knyg' ); ?></a>
    </div>
    </div>
                        ...
                        <div class="item">
                            ...
                            <div class="name">
                                <img src="<?php echo get_sub_field( 'kartynka_profilya' )['url'] ?>"
                                     alt="<?php echo get_sub_field( 'kartynka_profilya' )['alt'] ?>"
                                     class="newsImg">
    ...
    <section class="contact"
             style="background-image:url(<?php echo get_field( 'fonove_zobrazhennya_kontakty' )['url']; ?>)">
        <div class=" container">
            <h2><?php the_field( 'zagolovok_kontakty' ) ?></h2>
            <div class="contact__row">
                <div class="shadow">

                </div>
                <div class="contact__left">
                    <h3><?php the_field( 'telefon_kontakty' ) ?></h3>
                    <a href="tel:+380677896523" class="phone"><?php the_field( 'nomer_telefona_kontakty' ); ?></a>
                    <h3><?php the_field( 'elektronna_adresa_kontakty' ) ?></h3>
                    <a href="mailto:info@grivtsov-center.com"
                       class="email"><?php the_field( 'sama_elektronna_adresa' ); ?></a>
                    <h3><?php the_field( 'soczialni_grupy_kontakty' ) ?></h3>
                    <div class="net">
                        <a target="_blanc" href="<?php the_field( 'fejsbuk_kontakty' ) ?>">
                        ...
                        <a target="_blanc" href="<?php the_field( 'tviter_kontakty' ) ?>">
                            <svg width=" 30" height="30" viewbox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a target="_blanc" href="<?php the_field( 'instagram_kontakty' ) ?>">
                            <svg width=" 30" height="30" viewbox="0 0 30 30" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                ...
                <div class="contact__right">
                    <img src="<?php echo get_field( 'zobrazhennya_kontakty' )['url'] ?>"
                         alt="<?php echo get_field( 'zobrazhennya_kontakty' )['alt'] ?>">
                </div>
            </div>
        </div>
    </section>
